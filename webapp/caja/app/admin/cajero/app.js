...
consoleBaseUrl = consoleBaseUrl.substring(0, consoleBaseUrl.indexOf("/app/admin/cajero"));
consoleBaseUrl = consoleBaseUrl + "/app/admin/cajero";
var configUrl = consoleBaseUrl + "/config";

var auth = {};
var authUrl = window.location.href.substring(0, window.location.href.indexOf('/admin/cajero'));
